...
The GT disparity maps for test scenes are AES-encoded, and a Matlab evaluation script  (.p file) is provided on our project website for standardized evaluation. $\textbf{They will be released soon after the manuscript is accpted}$
